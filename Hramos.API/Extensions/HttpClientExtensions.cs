...
public static class HttpClientExtensions
{
    ...
    public static HttpClient ConfigureHttpClientForQdrant(this HttpClient httpClient, QdrantOptions qdrantOptions)
    {
        ...
        httpClient.DefaultRequestHeaders.Remove(Constants.HttpClients.QdrantApiKeyHeader);

        if (!string.IsNullOrWhiteSpace(qdrantOptions.ApiKey))
        {
            httpClient.DefaultRequestHeaders.Add(Constants.HttpClients.QdrantApiKeyHeader, qdrantOptions.ApiKey);
        }
